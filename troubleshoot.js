...

    {
...

        {
...

            {
                ...
                stringOutput = stringMessage2 + stringMessage3 + stringMessage4;                //removed parenthesis and change && to plus since you just combining strings. 
...

            {
                ...
                stringOutput= stringMessage4 + stringMessage5;                               //removed parenthesis and change && to plus since you just combining strings. 
...

            {
                ...
                stringOutput = stringMessage1 + stringMessage2 + stringMessage3;             //removed parenthesis and change && to plus since you just combining strings. 
...

            {
                ...
                stringOutput = stringMessage5;                                               //removed parenthesis
...

    {
...

        {
...

            {
                ...
                stringOutput = stringMessage3 + stringMessage4;                                 //removed parenthesis and change && to plus since you just combining strings. 
...

            {
                ...
                stringOutput = stringMessage4;                                                  //removed parenthesis
...

        {
...

            {
                ...
                stringOutput = stringMessage3;                                                      //removed parenthesis
...

            {
                ...
                stringOutput = stringMessage6;                                                  //removed parenthesis

            }

        }                                                                                          //added

    }                                                                                           //switch to right bracket
