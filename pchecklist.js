...
// below are the list of passwords that are not good ones to use and we want to avoid
    ...
    stringOutput = "";
    //This test checks to see the length of the password to make sure it is 8 characters or more.
   // If the password is less, a message will be shared with the user letting them know of the error.
    ...
    //If the password entered meets the correct criteria, the user will be alerted that the password is correct.
    if (stringOutput != "")
    {
