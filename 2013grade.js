...
floatFinPts = parseFloat(prompt("Please enter pts from final exam (0-35):"));

floatTotalPts = parseFloat(floatHwPts + floatMidPts + floatFinPts);

intGradeOption = parseInt(prompt("Please enter 1 as pass/fail option or 2 as letter grade option"));
